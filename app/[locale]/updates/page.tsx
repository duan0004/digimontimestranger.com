      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3">
                      <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                        {t('version', { version: update.version })}
                      </h2>
        ...
        <div className="card p-6 mt-8 bg-gradient-to-br from-blue-50 to-primary-50 dark:from-blue-900/20 dark:to-primary-900/20 border-2 border-primary-200 dark:border-primary-800">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            {t('cta.note')} <a href="https://www.bandainamcoent.com" target="_blank" rel="noopener noreferrer" className="text-primary-600 dark:text-primary-400 hover:underline">Bandai Namco website</a>.
          </p>
        </div>
      </div>
    </div>
